...
npt_steps           = 4_000_000    # 4_000_000 for full 4 ns run
output_interval     = 10_000     # density CSV every 5 ps (at full scale)
trajectory_interval = 50_000     # xyz frame every 25 ps
checkpoint_interval = 500_000     # checkpoint every 250 ps
progress_interval   = 800_000     # print % every 10%
chunk_size          = 500     # steps per dyn.run() call — reduces Python overhead
...
print(f"\nRunning NPT (Nose-Hoover): T={T} K  P=1 atm  dt={dt/units.fs} fs  "
