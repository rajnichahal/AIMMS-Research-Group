...
def main():
    ...
    print("\n"+"="*72)
    print("  V7 ANALYSIS COMPLETE  —  Output files:")
    print("="*72)
    for a_p,b_p in pairs:
...
# python V7_cord_inter_intra.py file.xyz 0 --stop 100 --bond-cut 1.8 --pairs Be-F --rmax 12.0 --nbins 300 --cn-cut 2.35 --mode ovito --avg --cluster --cluster-atom Be --prob-plot
