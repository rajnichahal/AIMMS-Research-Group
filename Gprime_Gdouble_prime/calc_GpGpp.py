...
Calculate G' and G'' using:
  - column reading and time axis (col0*0.001, col1=strain, col2=stress)
  - smoothing (savgol window=501, polyorder=3)
  - FFT-based frequency detection + sinusoidal fit for G'/G''
...
VISCO_FILES = [
    (f"{BASE}/Folder_location/visco_file.dat", "Model_name (for eg AL4_100k)",     100 #Temperature(for eg 100), "original #Config name "),
    (f"{BASE}/Folder_location/visco_file.dat","Model_name",  100 , "original"),
    (f"{BASE}/Folder_location/visco_file.dat","Model_name",     300, "original"),
    (f"{BASE}Folder_location/visco_file.dat", "Model_name",     100, "original"),

#Can be added more using the same above format
